...
export function SiteHeader() {
  return <header className="site-header"><div className="shell nav-wrap"><Link className="brand" href="/" aria-label="JakeGenerates home"><span className="brand-mark" aria-hidden="true">JG</span><span className="brand-name">Jake<span>Generates</span><i aria-hidden="true">.</i></span></Link><nav aria-label="Primary navigation"><Link href="/#tools">Tools</Link><Link href="/about">About</Link><Link className="nav-contact" href="/contact">Contact <span aria-hidden="true">↗</span></Link></nav></div></header>;
}

export function SiteFooter() {
  return <footer className="site-footer"><div className="shell footer-top"><div><Link className="brand footer-brand" href="/"><span className="brand-mark" aria-hidden="true">JG</span><span className="brand-name">Jake<span>Generates</span><i aria-hidden="true">.</i></span></Link><p>Small tools for the work you do every day.</p></div><nav aria-label="Footer navigation"><Link href="/about">About</Link><Link href="/contact">Contact</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></nav></div><div className="shell footer-bottom"><span>© {new Date().getFullYear()} JakeGenerates</span><span>Made to make work easier.</span></div></footer>;
}
