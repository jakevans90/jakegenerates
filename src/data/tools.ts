...
export const tools: readonly Tool[] = [
  ...
  { id: "hvac-maintenance-agreement-price-calculator", name: "HVAC Maintenance Agreement Price Calculator", category: "calculator", question: "What should this maintenance agreement cost?", description: "Price recurring HVAC maintenance agreements using visits, labor, travel, materials, parts allowances, overhead, and target margin.", features: ["Visits & labor", "Travel & routine materials", "Annual parts allowance", "Fixed or percentage overhead", "Margin or markup pricing"], cta: "Price an HVAC Maintenance Agreement", url: "https://hvac-maintenance.jakegenerates.com/", professions: ["hvac"], professionSpecific: "hvac" },
  { id: "hvac-replacement-estimate-calculator", name: "HVAC Replacement Estimate Calculator", category: "calculator", question: "What should I charge for this replacement?", description: "Estimate HVAC replacement cost, recommended selling price, profit, and margin from equipment, labor, materials, subcontractors, overhead, and other job costs.", features: ["Equipment & accessories", "Primary & helper labor", "Removal, permits & logistics", "Fixed or percentage overhead", "Margin, markup & quote comparison"], cta: "Estimate an HVAC Replacement", url: "https://hvac-replacement.jakegenerates.com/", professions: ["hvac"], professionSpecific: "hvac" },
...
export const professions: readonly Profession[] = [
  { slug: "hvac", name: "HVAC", cardDescription: "Price service calls, maintenance agreements, and replacement work, then manage the paperwork around every HVAC job.", description: "Pricing calculators and service-document tools for HVAC contractors, from labor rates and service-call pricing to maintenance agreements, replacement estimates, quotes, reports, and invoices.", metaDescription: "Free HVAC pricing calculators for service calls, maintenance agreements, and replacement estimates, plus quote, report, and invoice tools for contractors.", specificToolsTitle: "HVAC-specific tools" },
