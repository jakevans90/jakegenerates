...
export const tools: readonly Tool[] = [
  ...
  { id: "hvac-maintenance-agreement-price-calculator", name: "HVAC Maintenance Agreement Price Calculator", category: "calculator", question: "What should this maintenance agreement cost?", description: "Price recurring HVAC maintenance agreements using visits, labor, travel, materials, parts allowances, overhead, and target margin.", features: ["Visits per year", "Labor hours & cost", "Travel & routine materials", "Annual parts allowance", "Fixed or percentage overhead", "Margin or markup pricing", "Monthly & per-visit equivalents", "Current agreement comparison"], cta: "Price an HVAC Maintenance Agreement", url: "https://hvac-maintenance.jakegenerates.com/", professions: ["hvac"], professionSpecific: "hvac" },
...
export const professions: readonly Profession[] = [
  { slug: "hvac", name: "HVAC", cardDescription: "Price service calls and maintenance agreements, then manage the paperwork around every HVAC job.", description: "Pricing calculators and service-document tools for HVAC contractors, from labor rates, service-call pricing, and maintenance agreements through quotes, reports, and invoices.", metaDescription: "Free HVAC pricing calculators for service calls and maintenance agreements, plus quote, report, and invoice tools for contractors." },
